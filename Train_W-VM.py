...
print("Starting 2")
vae, encoder, decoder = make_vae(renorm_clip={'rmin':1./2,'rmax':2.,'dmax':2.})
...
vae, encoder, decoder = make_vae(renorm_clip={'rmin':1./5,'rmax':5.,'dmax':5.})
